    ...
    <section className="w-full bg-gray-50 py-12 md:py-16">
      <div className="max-w-[1320px] mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <span className="text-[#FF6B6B] font-medium text-sm uppercase tracking-wider">WE'D LOVE TO HEAR FROM YOU</span>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/2 bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <form className="space-y-4">
              ...
              <button 
                type="submit" 
                className="w-full bg-[#FF6B6B] hover:bg-[#FF5252] text-white font-medium py-2.5 rounded-md transition-colors duration-200"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[#FF6B6B] mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
